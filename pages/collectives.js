    ...
    <>
      <div className="container justify-center flex flex-wrap">
        <div className="max-w-sm py-10 pr-10 pl-10">
          <div className="bg-stone-400 relative shadow-2xl hover:shadow-xl transition duration-500 rounded-lg border-2">
            ...
            <div className="py-6 px-8 rounded-lg content-center">
              ...
              <div classNameName='flex justify-center'>
                <Link href="/collectives/octov">
                  <button className="border-2 justify-center mt-6 py-2 px-4 font-bold rounded-lg shadow-md hover:shadow-lg">Get your GoldEvent NFT</button>
                </Link>
              </div>
            </div>
